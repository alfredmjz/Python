...
class Setup:
    ...
    def __init__(self, traffic):
        ...
        traffic[4] = traffic[0].number_of_traffic + traffic[1].number_of_traffic + traffic[2].number_of_traffic + traffic[3].number_of_traffic
...
if __name__ == '__main__':
    ...
    traffic_size = 0
    traffic = [traffic_up,  traffic_right, traffic_down, traffic_left, traffic_size]
    setup = Setup(traffic)
    ...
    intersection.display(traffic, current_lane)
    elapsed_time = int(time.perf_counter() - start_time)
    print("Intersection is cleared.\nTotal time taken: {}s,\t Total rotation taken: {}".format(elapsed_time, total_rotation))
